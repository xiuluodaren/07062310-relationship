...
import com.wms.view.MainView;
import com.wms.view.RegisterView;
...
import javafx.stage.Stage;
 ...
 public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        //添加组件
        group.getChildren().addAll(userNameLabel, userNameTF, pwdLabel, pwdTF, registerBtn, loginBtn, exitBtn);
